...
parts = helpers.query(
    """
      ...
      left join part_bins on canonical_part_num=part_bins.part_num
      ...
      left join elements on elements.color_id = my_parts.color_id and elements.part_num = my_parts.part_num
      where (part_bins.bin_id not null and bins.sort_style != 'unsorted') or (quantity >= 20 and my_parts.part_num not like '%pr%')
