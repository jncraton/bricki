...
for page in range(1,290):
  ...
  http.request('GET', '/api/v3/lego/parts/?page=%d&page_size=100' % page, headers={'Authorization': 'key QAfRgbiakP'})
  ...
  for part in part_details['results']:
    ...
    cursor.execute("""
      ...
      (part['part_num'], bricklink_id, brickowl_id, ldraw_id, lego_id, 
      part['part_url'], part['part_img_url']))
